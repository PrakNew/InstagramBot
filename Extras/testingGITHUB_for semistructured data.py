...
def build_dict_hierarchy(texts):
    data = {
        'General Info': {
            'Name': texts[0][0],
            'Company Name': texts[0][0],#changed here from 1
            'Issue': texts[0][0][:-5],#changed here from 2
            'Year': texts[0][0][-4:]#same as above
        }
    }
...
if __name__ == "__main__":
    ...
    file=r"C:\Users\prakhar.newatia\Downloads\tosend\Data Ingestion\Wagga Trade Spec -from Agile information - 49247 Pacific Corned Beef 453gx24.pdf"
